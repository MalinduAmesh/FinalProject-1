...
public class RegisterFormController {
    ...
    public JFXTextField txtRegInstructor;
    public JFXTextField txtRegId;
    public JFXTextField txtRegEndDate;
    public JFXTextField txtRegStartDate;
    public JFXRadioButton rdoRegCash;
    public JFXRadioButton rdoRegCard;
    public JFXTextField txtCustomerName;
    public JFXTextField txtCustomerAddress;
    public JFXTextField txtCusContact;
    public JFXTextField txtCusDOB;
    public JFXTextField txtCusEmail;
    public JFXTextField txtCusWeight;
    public JFXTextField txtCusHeight;
